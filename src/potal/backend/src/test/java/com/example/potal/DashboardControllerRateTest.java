...
class DashboardControllerRateTest {
    ...
    void billingExpressionsOverrideLegacyRatesPerModel() {
        ...
        Map<String, String> expressions = Map.of(
            "gpt-5.6-luna", "tier(\"openai_price_gpt55\", p * 1.2 + c * 12)",
            "gpt-5.6-sol", "tier(\"openai_price_gpt55\", p * 3.5 + c * 12)",
            "gpt-5.6-terra", "tier(\"openai_price_gpt55\", p * 2 + c * 12)"
        );
        ...
        assertEquals(0.6, rates.get("gpt-5.6-luna").input());
        ...
        assertEquals(1.0, rates.get("gpt-5.6-terra").input());
        assertEquals(6.0, rates.get("gpt-5.6-terra").output());
